...
var fileExtRegex = /.*\.(.*?)[\!\?\&\#]/g;
var GetTheHtmlCode = function () {
    var contentHtml = $('#innerdocbody').html();
    // DonwloadImages(contentHtml);
    var $TEMPElement = $("<div>" + contentHtml + "</div>");
    var downloadCLI = '';
    ...
    contentHtml = contentHtml
        .replace(/\s?(id|data-author-name|style)=".*?"/g, '')
        .replace(/div/g, 'p')
        .replace(/<p>(<inherit>)?<br>(<\/inherit>)?<\/p>/g, '');
    var $textarea = $("<textarea class=\"spider_sm_textwrap\">" + contentHtml + "</textarea>");
...
(function () {
    ...
    $('head').append(__STYLE);
    // Add Button to Page
    var $btn = $("<a class=\"spider_sm_button\">" + __ICON + "</a>");
    $('body').append($btn);
