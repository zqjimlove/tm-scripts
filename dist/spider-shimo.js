...
(function () {
  // Add Css to Head
  $('head').append(__STYLE); // Add Button to Page

  var $btn = $("<a class=\"spider_sm_button\">".concat(__ICON, "</a>"));
  $('body').append($btn); // Bind the button click event
